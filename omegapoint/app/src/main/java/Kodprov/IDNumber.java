...
public class IDNumber implements Number {
    // a Number must have a validate() function
    // an ID number is a Number,
    // it has some formatting rules and a correct Luhns number
